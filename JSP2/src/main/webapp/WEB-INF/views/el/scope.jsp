...
<body>
  ...
  <h3>범위별 객체의 세팅된 값(속성) 얻어오기</h3>

  <pre>
    - 제출된 파라미터 얻어오는 EL : \${param.key} 

    - 범위별객체에 세팅된 값 얻어오는 EL구분
      1) \${000Scope.key} ex) \${requestScope.key}
      2) \${key}
      .  -> 좁은범위 객체부터 탐색하여 일치하는 키가 있으면 얻어옴
  </pre>

  <ul>
    <li>Page scope : ${sessionValue}</li>

    <li>Sequest scope : ${requestScope.requestValue} </li>

    <li>Session scope : ${sessionValue}</li>

    <li>Application scope : ${sessionValue}</li>
  </ul>

  <a href="/el/check">객체범위 확인 페이지로 이동</a>
